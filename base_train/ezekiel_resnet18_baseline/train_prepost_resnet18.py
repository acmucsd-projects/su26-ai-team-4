#!/usr/bin/env python3
"""Shared-backbone PRE+POST ResNet-18 with inverse-frequency weighted CE."""
...
def main():
    args = add_training_arguments("Train the paired PRE+POST xBD ResNet-18 experiment.",
                                 BASELINE_DIR / "cache" / "cache_manifest.csv", BASELINE_DIR / "results_prepost")
    run_experiment(args, ExperimentSpec(
        model_name="prepost_resnet18", title="xBD PAIRED PRE+POST RESNET-18 EXPERIMENT",
        input_mode="prepost_shared_backbone_concat", loss_name="inverse_frequency_weighted_cross_entropy",
        class_weighting=True, loss_display="inverse-frequency weighted cross entropy",
